...
/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todo.js */ "./src/modules/logic/todo.js");
...
class Project {
    constructor(name, ...initialTodos) {
        ...
        this._id = `proj${(0,uuid__WEBPACK_IMPORTED_MODULE_1__["default"])()}`;
    }
    ...
    sortTodoListByDate() {
        this._todoList.sort((a, b) => {
            const dateA = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(a.dueDate, 'do MMM', new Date());
            const dateB = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(b.dueDate, 'do MMM', new Date());
            return dateA - dateB;
        });
    }
...
class ProjectsList {
    ...
    get dayProject() {
        const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'do MMM');
        const todayTodos =
    ...
    get weekProject() {
        ...
        const startOfWeekDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(today, { weekStartsOn: 1 });
        const daysOfWeek = [];

        // Get the formatted date for each day of the week
        for (let i = 0; i < 7; i++) {
            const day = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(startOfWeekDate, i);
            const formattedDay = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(day, 'do MMM');
    ...
    static fromJSON(json) {
        ...
        const personalProjectsList = json._personalProjectsList.map(project => {
            const todoList = project._todoList.map(todo => {
                return new _todo_js__WEBPACK_IMPORTED_MODULE_0__.TodoItem(todo._name, todo._urgency, todo._description, todo._dueDate, todo._isDone);
            });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getProjectsListFromStorage: () => (/* binding */ getProjectsListFromStorage),
/* harmony export */   saveProjectsListToStorage: () => (/* binding */ saveProjectsListToStorage),
...
function getProjectsListFromStorage() {
    if(!storageAvailable('localStorage')) { return; }
    return JSON.parse(localStorage.getItem('myProjectsList'));
}

function saveProjectsListToStorage(projectsList) {
...
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants.js */ "./src/constants.js");
/* harmony import */ var _modules_logic_storage_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/logic/storage.js */ "./src/modules/logic/storage.js");
/* harmony import */ var _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/logic/project.js */ "./src/modules/logic/project.js");
/* harmony import */ var _modules_logic_todo_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/logic/todo.js */ "./src/modules/logic/todo.js");
/* harmony import */ var _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/dom/project.js */ "./src/modules/dom/project.js");
/* harmony import */ var _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/dom/todo.js */ "./src/modules/dom/todo.js");
/* harmony import */ var _modules_dom_dialog_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/dom/dialog.js */ "./src/modules/dom/dialog.js");
...
if((0,_modules_logic_storage_js__WEBPACK_IMPORTED_MODULE_1__.storageAvailable)('localStorage')) {
    if(localStorage.getItem('myProjectsList')) {
        const parsedProjectsList = (0,_modules_logic_storage_js__WEBPACK_IMPORTED_MODULE_1__.getProjectsListFromStorage)();
        myProjectsList = _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_2__.ProjectsList.fromJSON(parsedProjectsList);
    }
...
function defaultMyProjectsList() {
    const addDaysToToday = (days) => (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(), days), 'do MMM');

    const defaultList = new _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_2__.ProjectsList(
        new _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_2__.DefaultProject('Inbox'), new _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_2__.DefaultProject('Today'), new _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_2__.DefaultProject('Week'));
    
    const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), 'do MMM');
    const initialProject = new _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_2__.Project('Init Project',
        new _modules_logic_todo_js__WEBPACK_IMPORTED_MODULE_3__.TodoItem('Feed myself', _constants_js__WEBPACK_IMPORTED_MODULE_0__.URGENCY_TYPE.HIGH, 'I must eat to gain energy', today, true),
        new _modules_logic_todo_js__WEBPACK_IMPORTED_MODULE_3__.TodoItem('Workout', _constants_js__WEBPACK_IMPORTED_MODULE_0__.URGENCY_TYPE.MEDIUM , 'I must gain strength to restore the Roman Empire', today),
        new _modules_logic_todo_js__WEBPACK_IMPORTED_MODULE_3__.TodoItem('Clean the house', _constants_js__WEBPACK_IMPORTED_MODULE_0__.URGENCY_TYPE.LOW, 'The house is too dirty', addDaysToToday(1), true),
        new _modules_logic_todo_js__WEBPACK_IMPORTED_MODULE_3__.TodoItem('Restablish the Roman Empire', _constants_js__WEBPACK_IMPORTED_MODULE_0__.URGENCY_TYPE.MEDIUM, 'Veni, Vidi, Vici', addDaysToToday(2)),
        new _modules_logic_todo_js__WEBPACK_IMPORTED_MODULE_3__.TodoItem('Crown me Caesar', _constants_js__WEBPACK_IMPORTED_MODULE_0__.URGENCY_TYPE.HIGH, 'Following the path of Augustus', addDaysToToday(3)),
        new _modules_logic_todo_js__WEBPACK_IMPORTED_MODULE_3__.TodoItem('Learn how to code', _constants_js__WEBPACK_IMPORTED_MODULE_0__.URGENCY_TYPE.MEDIUM, 'It\'s funny', addDaysToToday(11), true),
        new _modules_logic_todo_js__WEBPACK_IMPORTED_MODULE_3__.TodoItem('Take a nap', _constants_js__WEBPACK_IMPORTED_MODULE_0__.URGENCY_TYPE.LOW, 'I\'m tired', addDaysToToday(17)));
...
function initializeState() {
    ...
    const inboxProjectButton =
        _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.displayDefaultProject(myProjectsList.inboxProject, 'assets/inbox_icon.svg');
    const dayProjectButton =
        _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.displayDefaultProject(myProjectsList.dayProject, 'assets/today_calendar_icon.svg');
    const weekProjectButton =
        _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.displayDefaultProject(myProjectsList.weekProject, 'assets/week_calendar_icon.svg');

    //Initialize active project
    const initialActiveProject = document.getElementById(myProjectsList.activeProject.id);
    _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.setActiveClassTo(initialActiveProject);
    const todosList = _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.renderProjectTodos(myProjectsList.activeProject);
    todosList.forEach(todo => setTodoElementListeners(todo));
    myProjectsList.isDefaultProjectId(initialActiveProject.id)
                ? _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.hideAddTodoButton() : _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.showAddTodoButton();
...
function setPersonalProject(project) {
    const projectButton = _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.displayPersonalProject(project);
...
function setActiveProjectListener(projectButton) {
    projectButton.addEventListener('click', () => {
        ...
        _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.setActiveClassTo(projectButton);
        
        const todosList = _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.renderProjectTodos(myProjectsList.activeProject);
        todosList.forEach(todo => setTodoElementListeners(todo));
        
        const isDefaultProject = myProjectsList.isDefaultProjectId(projectButton.id);
        isDefaultProject ? _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.hideAddTodoButton() : _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.showAddTodoButton();
    });
}
...
function setDeleteProjectListener(projectButton) {
    ...
    deleteIcon.addEventListener('click', (e) => {
        ...
        _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.removePersonalProject(projectButton);
        if(myProjectsList.activeProject.id === projectButton.id) {
            myProjectsList.activeProject = myProjectsList.inboxProject;
            _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.setActiveClassTo(document.getElementById(myProjectsList.activeProject.id));
            _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.renderProjectTodos(myProjectsList.activeProject);
        }
        (0,_modules_logic_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveProjectsListToStorage)(myProjectsList);
    });
}
...
function setCreateTodoDialogListeners(dialog) {
    ...
    form.addEventListener('submit', (e) => {
        ...
        const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(todoDate), 'do MMM');

        const newTodo = new _modules_logic_todo_js__WEBPACK_IMPORTED_MODULE_3__.TodoItem(todoTitle, todoUrgency, todoDescription, formattedDate);
        myProjectsList.activeProject.add(newTodo);
        const todoElement = _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.renderSingleTodo(newTodo);
...
function setTodoElementListeners(todoElement) {
    ...
    todoCheckbox.addEventListener('change', () => {;   
        ...
        _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.toggleTodoDone(todoElement);
        (0,_modules_logic_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveProjectsListToStorage)(myProjectsList);
    });

    const todoDetailsButton = todoElement.querySelector('.todo-details');
    todoDetailsButton.addEventListener('click', () => {
        _modules_dom_dialog_js__WEBPACK_IMPORTED_MODULE_6__.renderTodoDetailsDialog(todoItem);
    });

    const todoEditButton = todoElement.querySelector('.todo-edit');
    todoEditButton.addEventListener('click', () => {
        const editDialog = _modules_dom_dialog_js__WEBPACK_IMPORTED_MODULE_6__.renderTodoEditDialog(todoItem);
        ...
        form.addEventListener('submit', (e) => {
            ...
            _modules_dom_todo_js__WEBPACK_IMPORTED_MODULE_5__.updateTodoValues(todoElement, todoItem);
            (0,_modules_logic_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveProjectsListToStorage)(myProjectsList);
            editDialog.remove();
        });
...
_constants_js__WEBPACK_IMPORTED_MODULE_0__.addButton.project.addEventListener('click', () => {
    _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.hideAddProjectButton();
    const form = _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.displayProjectForm();

    form.addEventListener('submit', (e) => {
        e.preventDefault();
        const projectName = form.querySelector('input').value;
        const newProject = new _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_2__.Project(projectName);
        myProjectsList.addPersonalProject(newProject);
        setPersonalProject(newProject);
        _modules_dom_project_js__WEBPACK_IMPORTED_MODULE_4__.showAddProjectButton();
        (0,_modules_logic_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveProjectsListToStorage)(myProjectsList);
        form.remove();
    });
...
_constants_js__WEBPACK_IMPORTED_MODULE_0__.addButton.todo.addEventListener('click', () => {
    const newTodoDialog = _modules_dom_dialog_js__WEBPACK_IMPORTED_MODULE_6__.renderNewTodoFormDialog();
