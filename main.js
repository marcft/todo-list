...
function renderTodoEditDialog(todo){
    ...
    const parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(todo.dueDate, 'do MMM', new Date());
    const deformattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(parsedDate, 'yyyy-MM-dd');
...
class ProjectsList {
    ...
    get dayProject() {
        const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'do MMM');
        const todayTodos =
    ...
    get weekProject() {
        ...
        const startOfWeekDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(today, { weekStartsOn: 1 });
        const daysOfWeek = [];

        // Get the formatted date for each day of the week
        for (let i = 0; i < 7; i++) {
            const day = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(startOfWeekDate, i);
            const formattedDay = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(day, 'do MMM');
...
const myProjectsList = new _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_1__.ProjectsList(
        ...
        new _modules_logic_project_js__WEBPACK_IMPORTED_MODULE_1__.Project('First Project'));
